...
async function signIn() {
    ...
    "ua": "Mozilla\\/5.0 (iPhone; CPU iPhone OS 18_2 like Mac OS X) AppleWebKit\\/605.1.15 (KHTML, like Gecko) Mobile\\/15E148",
    "isSetProxy": "false",
    "isUsingVpn": "false",
    "os": "iOS",
    "isLBSEnabled": "false",
    ...
    //     "X-Data-Sign": sign,
    //     "sweet_security_info": `{"osVersion":"18.2","ip":"192.168.2.1","geelyDeviceId":"${$.devicesn}","deviceUUID":"${$.devicesn}","brand":"Apple","appVersion":"${$.appversion}","channel":"ios%E5%AE%98%E6%96%B9","ua":"Mozilla\\/5.0 (iPhone; CPU iPhone OS 18_2 like Mac OS X) AppleWebKit\\/605.1.15 (KHTML, like Gecko) Mobile\\/15E148","isSetProxy":"false","isUsingVpn":"false","os":"iOS","isLBSEnabled":"false","platform":"ios","isJailbreak":"false","networkType":"NETWORK_WIFI","battery":"80","os_version":"18.2","isCharging":"2","model":"iPhone17,2","screenResolution":"1290 * 2796"}`
    // });
    headers = Object.assign(getHeaders(), {
        "X-Data-Sign": sign,
        "sweet_security_info": JSON.stringify(sweet_security_info)
    });
